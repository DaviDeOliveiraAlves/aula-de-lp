...
const start = async () => {
  ...
  while (true) {
    ...
    const option = await select({
      ...
      choices: [
        {
          name: chalk.magenta("Cadastrar meta"),
          value: "register",
        },
        {
          name: chalk.cyan("Porcentagem da(s) meta(s)"),
          value: "percentage",
        },
        {
          name: chalk.hex("#FFA500")("Listar meta(s)"),
          value: "list",
        },
        {
          name: chalk.magenta("Listar meta(s) realizada(s)"),
          value: "completed",
        },
        {
          name: chalk.cyan("Listar meta(s) não realizada(s)"),
          value: "incompleted",
        },
        {
          name: chalk.hex("#FFA500")("Atualizar meta(s)"),
          value: "update",
        },
        {
          name: chalk.magenta("Deletar meta(s)"),
          value: "delete",
        },
        {
          name: chalk.cyan("Sair"),
          value: "out",
        },
      ],
    });
    ...
    switch (option) {
      ...
      case "delete":
        ...
        break;
      case "out":
        console.log(chalk.red.bold("Até a próxima!"));
        return;
    }
  }
};
